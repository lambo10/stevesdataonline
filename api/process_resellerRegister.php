...
$sql = "INSERT INTO users (name,email,phone,password,whoReferredID,referralID,gender,state,apiKey,accType)
VALUES ('$name','$email','$phone','$password','$whoReferred_id','$token','$gender','$state','$apiKey','Reseller')";
