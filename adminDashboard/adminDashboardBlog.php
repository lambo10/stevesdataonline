						...
						<div class="titlebar-col col-md-12 bg-white pt-10 bg-white box-shadow-1">
							<div class="row">
								...
								<div class="col-md-2 col-md-offset-1">
									<h6 class="font-size-14 font-weight-medium text-uppercase ltr-sp-2">COMMENTS</h6>
								</div><!-- /.col-md-2 -->
                            ...
                            <div class="contact-form contact-form-button-block font-size-14">
                                    ...
                                    <div class="row d-flex flex-wrap">
                                        <div class="lqd-column col-md-12 mb-20">
                                            ...
                                            <textarea id="post_body" class="bg-gray text-dark" type="text" name="post_body"  placeholder="Comment" required>
                                            </textarea>
