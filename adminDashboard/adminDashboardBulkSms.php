						...
						<div class="titlebar-col col-md-12 bg-white pt-10 bg-white box-shadow-1">
							<div class="row">
								...
								<div class="col-md-2 col-md-offset-1">
									<h6 class="font-size-14 font-weight-medium text-uppercase ltr-sp-2">BULK SMS</h6>
								</div><!-- /.col-md-2 -->
							...
							<div class="lqd-column-inner bg-white border-radius-6 px-3 px-md-4 pt-40 pb-40">
								...
								<form novalidate="novalidate">
									...
									<div class="row d-flex flex-wrap">
                                        ...
                                        <input class="bg-gray text-dark mb-30" type="number" id="fromIn" aria-required="true" aria-invalid="false" placeholder="from" required>
											<input class="bg-gray text-dark mb-30" type="number" id="toIn" aria-required="true" aria-invalid="false" placeholder="to" required>
											<input class="bg-gray text-dark mb-30" type="number" id="price_per_unitIn" aria-required="true" aria-invalid="false" placeholder="price per unit" required>
            ...
            <section class="vc_row pb-50 bg-cover bg-center" style="background: rgb(228, 228, 240);">
				...
				<div class="container">
                    ...
                    <div class="lqd-column col-md-12 px-4 pb-30 bg-white box-shadow-1">
							...
							<div class="lqd-column-inner bg-white border-radius-6 px-3 px-md-4 pt-40 pb-40">
                        <div>
                        <h6 class="font-size-14 font-weight-medium text-uppercase ltr-sp-2">Pricing</h6>
...
<script>
     $.fn.get_Admin_Users = function(){ 
		var resultJson = null;
	$.get('../api/get_admin_bulkSmsPricing.php',{},function(result){
	...
	$.fn.submit_data = function(){
		dispSubmitBtnLoader();
			...
			var toIn = $("#toIn").val();
			var price_per_unitIn = $("#price_per_unitIn").val();
				
				$.post( "../api/process_insertNewBulkSmsPrice.php",{
                    fromIn: fromIn,
                    toIn: toIn,
					price_per_unitIn: price_per_unitIn
